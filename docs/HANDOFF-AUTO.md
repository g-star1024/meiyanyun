...
<!-- MACHINE:CARD=B49 卡8 目标管理 /m1-target 整页去 mock 已闭合（feat `1f432a2` 已推送、GROUP 行重复渲染遗留缺陷修复、三轨全绿、批中回写 docs `c8c6e65` 已推送）→ 卡9 合规中心 /m1-compliance（audit-service 扩展）待开工 -->
