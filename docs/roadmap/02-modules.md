...
| 模块 | 状态 | 完成批次 | 真实依据 | 缺口 / 备注 |
|---|---|---|---|---|
| 登录 / JWT | ✅ | M7 | DELIVERY-M7，/api/org/auth/login；B50 卡5 `7f08103` | B50 卡5 登录页全局壳四门控（未登录不预拉 permissions/stores×2/notifications，闭合 B49 卡12 四路 401 观察项，4 files +52/-23，前端 bundle index-SOVxdEZ6.js） |
