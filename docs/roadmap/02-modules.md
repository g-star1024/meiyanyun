...
| M1 · 数据大屏（/m1-screen） | ✅ | P5-B49 卡7 | DELIVERY-P5-B49，`815f006` | txn-service 新建 screen 包（GET /screen/overview 六 KPI+hourly+品类占比+门店 top5 快照、GET /screen/stream SSE 流、ScreenOrderFanoutJob 3s 轮询 order_payment 扇出广播 order-paid、StoreProjectClient SKU→品类映射 X-Internal-Token 60s 缓存），P0 SSE 认证串扰+nginx SSE 缓冲双缺陷修复，三轨真验全绿 |
