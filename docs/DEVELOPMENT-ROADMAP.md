...
|---|---|---|---|
| ✅ 已完成 | **74** | 45% | 三者齐备，真实闭环 |
| 🔧 半成品 | **3** | 2% | 后端有端点/前后端均实但缺验证或前端 mock |
