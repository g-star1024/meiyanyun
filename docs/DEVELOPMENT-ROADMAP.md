...
| ⑦ | 组织与权限 | 9 | 1 | 14 | **闭环✅**（登录/RBAC/主数据）；B26 通知多渠道（SSE/扇出/免打扰）收口；M2 运营为远期 |
