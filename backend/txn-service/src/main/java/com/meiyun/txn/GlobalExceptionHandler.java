...
public class GlobalExceptionHandler {
    ...
    /** 双签硬校验未通过 → 400。 */
    @ExceptionHandler(DualSignException.class)
    public ResponseEntity<Map<String, Object>> handleDualSign(DualSignException ex) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("error", "DUAL_SIGN_VIOLATION");
        body.put("messages", ex.getViolations());
