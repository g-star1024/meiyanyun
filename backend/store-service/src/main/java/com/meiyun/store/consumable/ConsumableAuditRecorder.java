 ...
 */
@Component
public class ConsumableAuditRecorder {

    private static final Logger log = LoggerFactory.getLogger(ConsumableAuditRecorder.class);

    private static final String SOURCE_SERVICE = "store-service";
    ...
    public ConsumableAuditRecorder(RestTemplate restTemplate, JdbcTemplate jdbcTemplate) {
