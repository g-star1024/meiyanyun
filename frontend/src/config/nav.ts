...
export const NAV_GROUPS: NavGroup[] = [
  ...
  // ========== 2. 客户运营 ==========
  {
    ...
    items: [
      ...
      { to: '/search-events', label: '检索事件处置台', icon: 'alert', permission: 'customer:search:admin' },
...
export const PAGE_TITLES: Record<string, PageTitle> = {
  ...
  '/search-events': { breadcrumb: '客户运营 / 检索事件处置台', title: '检索事件处置台', subtitle: '客户搜索 outbox 投递监控 · 人工重试 / 重放 / 丢弃' },
