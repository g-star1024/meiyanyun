...
export const DOMAIN_HOME: Record<Exclude<DomainKey, 'ai'>, DomainHomeMeta> = {
  ...
  admin: {
    ...
    highlights: [
      { label: '组织架构', value: 'T1', to: '/m1-org', tone: 'purple' },
      { label: '角色权限', value: 'RBAC', to: '/m1-rbac', tone: 'blue' },
      { label: '工单中心', value: '7 待处理', to: '/workorders', tone: 'orange' },
      { label: '合规审计', value: '日志', to: '/m1-compliance', tone: 'success' },
    ],
    todosTitle: '管理待办',
    todos: [
      { title: '权限申请待审批', desc: '咨询师林微申请「客户导出」权限，待管理员审批', time: '30 分钟前', type: 'approval', to: '/m1-rbac' },
